...
module.exports.fetchAmazonOrders = async (req, res, next) => {
    ...
    //var date = req.body.date ? req.body.date : '2019-04-05T19:00:00Z';
    // Array for storing Amazon Order IDS
    var orderIDS = [];
    var throttledIds = [];
    var NextToken = '';
    ...
    async function listAllOrders(listAllOrdersCallback) {
        ...
        await amazonMws.orders.search({
                ...
                //'LastUpdatedAfter':'2019-03-23T19:00:00Z',
                //'LastUpdatedAfter': date2
                ...
                var nextToken = "";
                //var nextToken = (response.NextToken != null || response.NextToken != undefined) ? response.NextToken : "";

                // if (response !== null && response !== undefined) {
                // if (Object.entries(response).length === 0 && response.constructor === Object) {
                //     console.log('Response is null');
                // } else {
                //     if (Object.entries(response.Orders.Order).length === 0 && response.Orders.Order.constructor === Object) {
                ...
                if (response !== null && response !== undefined) {
                    ...
                    //console.log('amznOrders----', amznOrders);
