...
+'</AmazonEnvelope>';
    ...
    // var productquant = req.body.productquant;
    // var productprice = req.body.productprice;
    // var samplefee = req.body.samplefee;
    // var miscfee = req.body.miscfee;
    // var setupfee = req.body.setupfee;
    // var inspectionfee = req.body.inspectionfee;
    // var unitshippingcost = req.body.unitshippingcost;
    // var referralfee = req.body.referralfee;
    // var fbafee = req.body.fbafee;
    // var prodcost = productquant * productprice;
    // var feetotal = parseFloat(samplefee) + parseFloat(miscfee) + parseFloat(setupfee) + parseFloat(inspectionfee);
    // var orderstagingcost = parseFloat(prodcost) + parseFloat(feetotal)
    // var shippingtotal = unitshippingcost * productquant;
    // var landedorder = (parseFloat(orderstagingcost) + parseFloat(shippingtotal)).toFixed(2);
    // var landedavgcost = (landedorder / productquant).toFixed(2);
    // var fulfilledunitcost = parseFloat(landedavgcost) + parseFloat(referralfee) + parseFloat(fbafee);
    // var amznfeeperorder = ((parseFloat(referralfee) + parseFloat(fbafee)) * productquant).toFixed(2);

    // const amzn = AmazonProductsSchema({
    //     user_id: user_id,
    //     SellerSKU: seller_sku_random,
    //     ProductName: productname,
    //     ProductDesc: productdesc,
    //     Principal: productquant,
    //     PostedDate: today,
    //     AvailableQuantity: productquant,
    //     ShippingCharge: unitshippingcost,
    //     FBA: fbafee,
    //     ReferralFee: referralfee,
    //     productCost: prodcost,
    //     feeTotal: feetotal,
    //     orderAndStagingFee: orderstagingcost,
    //     shippingTotal: shippingtotal,
    //     landedOrder: landedorder,
    //     landedAvgCost: landedavgcost,
    //     fulfilledUnitCost: fulfilledunitcost,
    //     amznFeePerOrder: amznfeeperorder,
    //     miscFee: miscfee,
    //     sampleFee: samplefee,
    //     setupFee: setupfee,
...
// Controller for saving product after it has been editted by the user.
...
module.exports.getReimbursements = (req, res, next) => {
    var orderRequest = function () {
        amazonMws.reports.submit({
            ...
            amazonMws.reports.search({
                ...
                'ReportRequestIdList.Id.1': 458811018036,
                'SellerId': 'ASO6U4SYGJ2CF',
                ...
                amazonMws.reports.search({
                    ...
                    if (response2) {
                        //console.log('reimbursements[0]------------', reimbursements[0]);
                        //console.log('length--------', reimbursements.length);
